...
function seed() {
  ...
  const duels = [
    ...
    { id: uid(), title: 'Sales vs IT', player_a: players[0].id, player_a2: players[2].id,
      player_b: players[3].id, player_b2: players[4].id,
      metric: 'Deals + saves', target: 30, score_a: 19, score_b: 22, status: 'live',
      stake: 'Losing pair runs the coffee for a week', starts_at: iso(daysAgo(3)), ends_at: inDays(3),
    ...
    { id: uid(), title: 'Closer Clash', player_a: players[0].id, player_b: players[1].id,
      player_a2: null, player_b2: null,
      metric: 'New connections', target: 15, score_a: 15, score_b: 11, status: 'finished',
      stake: 'Corner desk for a month', starts_at: iso(daysAgo(20)), ends_at: iso(daysAgo(13)),
